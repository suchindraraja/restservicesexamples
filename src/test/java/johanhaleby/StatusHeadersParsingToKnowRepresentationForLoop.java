...
public class StatusHeadersParsingToKnowRepresentationForLoop
{
	public static void main(String[] args) throws Exception
	{
		...
		//Get Specific Header Value(Validate Representation(format) of resource)
		...
		{
			System.out.println("Response is in Comma Seperated Value");
		}
		else
		{
